...
You can run next command line to install NodeJs v10 and instal NPM

    curl -o- https://raw.githubusercontent.com/nvm-sh/nvm/v0.34.0/install.sh | bash && nvm install 10.16.0 && rm -rf node_modules && npm cache clean --force && npm install
